        ...
        <FooterLinksContainer>
          ...
          <FooterLinksWrapper>
            ...
            <FooterLinkItems>
              ...
              <FooterLink to='/shops '>Artisans</FooterLink>
              <FooterLink to='/services'>Creators</FooterLink>
              <FooterLink to='/professionals'>NGOs</FooterLink>
              <FooterLink to='/addbusiness'>Local Businesses</FooterLink>
              <FooterLink to='/addbusiness'>Trade Associations</FooterLink>
            </FooterLinkItems>
          </FooterLinksWrapper>
        </FooterLinksContainer>
